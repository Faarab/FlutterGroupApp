...
class EditItineraryBodyBotNavVersion extends StatefulWidget {
  const EditItineraryBodyBotNavVersion({super.key, required this.widget});

  final EditTripScreen widget;

  @override
  State<EditItineraryBodyBotNavVersion> createState() => _EditItineraryBodyBotNavVersionState();
}

class _EditItineraryBodyBotNavVersionState extends State<EditItineraryBodyBotNavVersion> {
