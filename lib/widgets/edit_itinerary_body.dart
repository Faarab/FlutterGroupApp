...
class EditItineraryBody extends StatefulWidget {
  const EditItineraryBody({super.key, required this.widget, required this.trip});
...
late String _name;
  ...
  print(data);
  _updatedTrip = widget.widget.trip.copyWith(
    name: _name,
  ...
  print("Io soy il trip modificato + $_updatedTrip");
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          ...
                          content:
                              const Text("Do you want to delete this city?"),
                          actions: [
                            Column(
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: TextButton(
                                        ...
                                        onPressed: () {
                                          setState(() {
                                            _citiesPerDay[_currentDayIndex]
                                                .removeAt(index);
                                          });
                                          Navigator.of(context).pop();
                                        },
