...
Future<String> getCurrencyRateAsync(String from, String to,) async {
  
  final urlWithQuery = Uri.parse('$urlApiConversion?apikey=$apiKey&currencies=$to&base_currency=$from');
